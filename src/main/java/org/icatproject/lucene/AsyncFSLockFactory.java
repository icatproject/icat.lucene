 ...
 *
 * <p>The primary benefit of {@link AsyncFSLockFactory} is that locks (not the lock file itself)
 ...
 *
 * <p>This has been modified from NativeFSLockFactory to use AsynchronousFileChannel instead of
 * FileChannel, to tolerate interrupts.
 * 
 * @see LockFactory
 */
public final class AsyncFSLockFactory extends FSLockFactory {

  /** Singleton instance */
  public static final AsyncFSLockFactory INSTANCE = new AsyncFSLockFactory();

  private static final Set<String> LOCK_HELD = Collections.synchronizedSet(new HashSet<String>());

  private AsyncFSLockFactory() {}
